...
const char *gengetopt_args_info_help[] = {
  ...
  "      --print-only          Do not save generated/restored wallet to disk but\n                              print result instead",
  "  -f, --file=FILENAME       Specify wallet file  (default=`wallet.json')",
  "  -a, --address             Print wallet address",
  "  -b, --balance             Print wallet balance",
  "  -s, --send                Create send transaction",
  "      --to=STRING           Specify transaction receipent address",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->restore_given = 0 ;
  args_info->print_only_given = 0 ;
  args_info->file_given = 0 ;
  args_info->address_given = 0 ;
  args_info->balance_given = 0 ;
  args_info->send_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->restore_arg = NULL;
  args_info->restore_orig = NULL;
  args_info->file_arg = gengetopt_strdup ("wallet.json");
  args_info->file_orig = NULL;
  args_info->to_arg = NULL;
  args_info->to_orig = NULL;
  args_info->amount_arg = NULL;
  args_info->amount_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->create_help = gengetopt_args_info_help[2] ;
  args_info->restore_help = gengetopt_args_info_help[3] ;
  args_info->print_only_help = gengetopt_args_info_help[4] ;
  args_info->file_help = gengetopt_args_info_help[5] ;
  args_info->address_help = gengetopt_args_info_help[6] ;
  args_info->balance_help = gengetopt_args_info_help[7] ;
  args_info->send_help = gengetopt_args_info_help[8] ;
  args_info->to_help = gengetopt_args_info_help[9] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->restore_arg));
  free_string_field (&(args_info->restore_orig));
  ...
  free_string_field (&(args_info->amount_arg));
  free_string_field (&(args_info->amount_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->restore_given)
    write_into_file(outfile, "restore", args_info->restore_orig, 0);
  if (args_info->print_only_given)
    write_into_file(outfile, "print-only", 0, 0 );
  if (args_info->file_given)
    write_into_file(outfile, "file", args_info->file_orig, 0);
  if (args_info->address_given)
    write_into_file(outfile, "address", 0, 0 );
  if (args_info->balance_given)
    write_into_file(outfile, "balance", 0, 0 );
  if (args_info->send_given)
    write_into_file(outfile, "send", 0, 0 );
  if (args_info->to_given)
    write_into_file(outfile, "to", args_info->to_orig, 0);
  if (args_info->amount_given)
    write_into_file(outfile, "amount", args_info->amount_orig, 0);
  if (args_info->fee_given)
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* Create new wallet.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->create_given),
              &(local_args_info.create_given), optarg, 0, 0, ARG_NO,
          ...
          break;
        case 'r':	/* Restore wallet from private key.  */
        
        
          if (update_arg( (void *)&(args_info->restore_arg), 
               &(args_info->restore_orig), &(args_info->restore_given),
              &(local_args_info.restore_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "restore", 'r',
              additional_error))
            goto failure;
          ...
          break;
        case 'f':	/* Specify wallet file.  */
        
        
          if (update_arg( (void *)&(args_info->file_arg), 
               &(args_info->file_orig), &(args_info->file_given),
              &(local_args_info.file_given), optarg, 0, "wallet.json", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "file", 'f',
              additional_error))
            goto failure;
          ...
          break;
        case 'a':	/* Print wallet address.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->address_given),
              &(local_args_info.address_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "address", 'a',
              additional_error))
            goto failure;
          ...
          break;
        case 'b':	/* Print wallet balance.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->balance_given),
              &(local_args_info.balance_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "balance", 'b',
              additional_error))
            goto failure;
          ...
          break;
        case 's':	/* Create send transaction.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->send_given),
              &(local_args_info.send_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "send", 's',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "print-only") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->print_only_given),
                &(local_args_info.print_only_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "print-only", '-',
                additional_error))
              goto failure;
          ...
          /* Specify transaction receipent address.  */
          else if (strcmp (long_options[option_index].name, "to") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->to_arg), 
                 &(args_info->to_orig), &(args_info->to_given),
                &(local_args_info.to_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "to", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "amount") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->amount_arg), 
                 &(args_info->amount_orig), &(args_info->amount_given),
                &(local_args_info.amount_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "amount", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "fee") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->fee_arg), 
                 &(args_info->fee_orig), &(args_info->fee_given),
                &(local_args_info.fee_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "fee", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "nonce") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->nonce_arg), 
                ...
                &(local_args_info.nonce_given), optarg, 0, 0, ARG_LONGLONG,
                check_ambiguity, override, 0, 0,
                "nonce", '-',
                additional_error))
              goto failure;
