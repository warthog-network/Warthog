...
//     public:
//         RewardSection(AccountId toId, Wart amount)
//         {
...
//     {
//     }
//     VersionedBodyContainer gen_block(NonzeroHeight height, const Address& miner,
...
// };
//
// VersionedBodyContainer BlockGenerator::gen_block(NonzeroHeight height,
//     const Address& miner,
...
//
//     // Reward Section
//     auto totalReward { Wart::sum_assert(height.reward(), trs.total_fee()) };
...
//     // should be valid
//     try {
//         [[maybe_unused]] auto parsed { body.parse_structure_throw(height, body.version) };
//         return body;
//     } catch (const Error& e) {
//         // disable transactions as fallback
//         spdlog::error("Cannot create mining task, body invalid: {}", e.err_name());
