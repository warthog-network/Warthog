...
Element focus(Element child) {
  return std::make_shared<Focus>(Elements{std::move(child)});
}
...
Element frame(Element child) {
  return std::make_shared<Frame>(Elements{std::move(child)}, true, true);
}
...
Element xframe(Element child) {
  return std::make_shared<Frame>(Elements{std::move(child)}, true, false);
}
...
Element yframe(Element child) {
  return std::make_shared<Frame>(Elements{std::move(child)}, false, true);
}
...
Element focusCursorBlock(Element child) {
  return std::make_shared<FocusCursor>(Elements{std::move(child)},
                                       Screen::Cursor::Block);
}
