...
#include "receiver.hpp" // for Receiver, Sender
#include "component.hpp"
#include "animation.hpp"      // for TimePoint
#include "captured_mouse.hpp" // for CapturedMouse
#include "event.hpp"          // for Event
#include "task.hpp"           // for Task, Closure
#include "../dom/selection.hpp"            // for SelectionOption
...
private:
  ...
  ScreenInteractive(Dimension dimension, int dimx, int dimy,
