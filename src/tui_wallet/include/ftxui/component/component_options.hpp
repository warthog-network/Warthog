...
#include "animation.hpp" // for Duration, QuadraticInOut, Function
#include "component_base.hpp" // for Component
...
struct ResizableSplitOption {
    ...
    Ref<int> main_size = (direction() == Direction::Left || direction() == Direction::Right) ? 20
                                                                                             : 10;
