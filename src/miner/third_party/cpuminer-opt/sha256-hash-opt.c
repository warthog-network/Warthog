...
int dummy(); // to disable warning: ISO C forbids an empty translation unit [-Wpedantic]
...
#include<stddef.h>
#include<stdint.h>
void sha256_transform_le( uint32_t *state_out, const uint8_t *input,
...
void sha256_transform_be( uint32_t *state_out, const uint8_t *input,
                           const uint32_t *state_in )
{
    __m128i STATE0, STATE1;
