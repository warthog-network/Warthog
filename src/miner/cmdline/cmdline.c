...
const char *gengetopt_args_info_purpose = "The reference implementation miner of the Warthog Network.\n\n\nBy Pumbaa, Timon & Rafiki";

const char *gengetopt_args_info_usage = "Usage: wart-miner [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT            Number of worker threads, use -1 for number of\n                                 cores  (default=`-1')",
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'a':	/* Specify address that is mined to.  */
          ...
          break;
        case 't':	/* Number of worker threads, use -1 for number of cores.  */
